...
//
	...
	#define NET_MSG_BASE				996					  // 기본 메시지
...
//-----------------------------------------------------------------------------------------------------------
	...
	//itemmall
	NET_MSG_GCTRL_GET_ITEMSHOP_FROMDB				= (NET_MSG_GCTRL + 1894),//<	구입한 아이템 정보 DB에서 가져오기 요청
	NET_MSG_GCTRL_GET_ITEMSHOP_FROMDB_FB			= (NET_MSG_GCTRL + 1895),//<	구입한 아이템 정보 DB에서 가져오기 요청 FB
	NET_MSG_GCTRL_BUY_ITEMSHOP						= (NET_MSG_GCTRL + 1896),//<	구입한 아이템 정보 DB에서 가져오기 요청
	NET_MSG_GCTRL_BUY_ITEMSHOP_FB					= (NET_MSG_GCTRL + 1897),//<	구입한 아이템 정보 DB에서 가져오기 요청 FB
	NET_MSG_GCTRL_BUY_ITEMSHOP_ITEM					= (NET_MSG_GCTRL + 1898),	//<	구입한 아이템 인벤에 넣기 요청.
	NET_MSG_GCTRL_ADD_ITEMSHOP_ITEM					= (NET_MSG_GCTRL + 1899),	//<	구입한 아이템 인벤에 넣기 요청.
	NET_MSG_GCTRL_ADD_ITEMSHOP_ITEM_FB				= (NET_MSG_GCTRL + 1900),	//<	구입한 아이템 인벤에 넣기 요청.
