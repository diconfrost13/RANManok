...
CPlayerKillType::CPlayerKillType () :
    m_bPLAY ( false )
{
}
...
void CPlayerKillType::CreateSubControl ( CString strKeyword )
{
...
void	CPlayerKillType::START()
{
	RESET ();
	m_bPLAY = true;
}

void	CPlayerKillType::RESET()
{
	m_fPlayedTime = 0.0f;
...
void CPlayerKillType::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
