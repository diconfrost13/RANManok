...
bool CInnerInterface::SET_PLAYERKILL_STREAK_ID ( int nID )
{
	...
	switch ( nID )
	{
		case PK_FIRST_BLOOD:			cID = CQuestionItemDisplay::FIRST_BLOOD;		break;
		case PK_DOUBLE_KILL:			cID = CQuestionItemDisplay::DOUBLE_KILL;		break;
		case PK_TRIPLE_KILL:			cID = CQuestionItemDisplay::TRIPLE_KILL;		break;
		case PK_ULTRA_KILL:				cID = CQuestionItemDisplay::ULTRA_KILL;			break;
		case PK_RAMPAGE:				cID = CQuestionItemDisplay::RAMPAGE;			break;
		case PK_KILLING_SPREE:			cID = CQuestionItemDisplay::KILLING_SPREE;		break;
		case PK_DOMINATING:				cID = CQuestionItemDisplay::DOMINATING;			break;
		case PK_MEGA_KILL:				cID = CQuestionItemDisplay::MEGA_KILL;			break;
		case PK_UNSTOPPABLE:			cID = CQuestionItemDisplay::UNSTOPPABLE;		break;
		case PK_WICKED_SICK:			cID = CQuestionItemDisplay::WICKED_SICK;		break;
		case PK_MONSTER_KILL:			cID = CQuestionItemDisplay::MONSTER_KILL;		break;
		case PK_GODLIKE:				cID = CQuestionItemDisplay::GODLIKE;			break;
		case PK_HOLY_SHIT:				cID = CQuestionItemDisplay::HOLY_SHIT;			break;
		case PK_OWNAGE:					cID = CQuestionItemDisplay::OWNAGE;				break;
	}
