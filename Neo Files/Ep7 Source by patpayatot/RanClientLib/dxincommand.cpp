...
namespace dxincommand
{
	...
	bool command ( const char* szcommand )
	{
		...
		if( strCOMMAND =="/pow")
		{
			...
			{
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::ORNAGERED,( "Successfully added your pow stats" ));
				return true;
			}
;}
		else if( strCOMMAND =="/dex")
		{
			...
			{
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::ORNAGERED,( "Successfully added your dex stats" ));
				return true;
			}
;}
		else if( strCOMMAND =="/int")
		{
			...
			{
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::ORNAGERED,( "Successfully added your int stats" ));
				return true;
			}
;}
		else if( strCOMMAND =="/vit")
		{
			...
			{
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::ORNAGERED,( "Successfully added your vit stats" ));
				return true;
			}
;}
		else if( strCOMMAND =="/sta")
		{
			if(strArray.GetSize() != 2)	
				return true;
			CString strPARAM_01 = strArray.GetAt(1);
			...
			{
				CInnerInterface::GetInstance().PrintMsgText ( NS_UITEXTCOLOR::ORNAGERED,( "Successfully added sta stats" ));
				return true;
			}
;}
		//	Note : GM 명령.
