...
//add pk
		...
		//add stats limit
		cFILE.getflag( "wPowMax", 1, 1, wPowMax );
		cFILE.getflag( "wStrMax", 1, 1, wStrMax );
		cFILE.getflag( "wSpiMax", 1, 1, wSpiMax );
		cFILE.getflag( "wDexMax", 1, 1, wDexMax );
		cFILE.getflag( "wIntMax", 1, 1, wIntMax );
		cFILE.getflag( "wStaMax", 1, 1, wStaMax );
//		cFILE.getflag( "dwAgiMax", 1, 1, dwAgiMax );
		...
		cFILE.getflag( "strCLICK_EFFECT",	1, 1, strCLICK_EFFECT );	//added by : SeiferXIII009 | 05-03-2012 | added mouse effect for char
		cFILE.getflag( "strTARGET_EFFECT",	1, 1, strTARGET_EFFECT );	//added by : SeiferXIII009 | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strMINE_EFFECT",	1, 1, strMINE_EFFECT );		//added by : SeiferXIII009 | 05-03-2012 | added item drop effect

		cFILE.getflag( "strTARGET_EFFECT_ENEMY",	1, 1, strTARGET_EFFECT_ENEMY );	//added by : geger009 | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strTARGET_EFFECT_NPC",	1, 1, strTARGET_EFFECT_NPC );	//added by : geger009 | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strTARGET_EFFECT_ALLIANCE",	1, 1, strTARGET_EFFECT_ALLIANCE );	//added by : geger009 | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strARROW_EFFECT_ENEMY",	1, 1, strARROW_EFFECT_ENEMY );	//added by : geger009 | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strARROW_EFFECT_NPC",	1, 1, strARROW_EFFECT_NPC );	//added by : geger009 | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strARROW_EFFECT_ALLIANCE",	1, 1, strARROW_EFFECT_ALLIANCE );	//added by : geger009 | 05-03-2012 | added mouse effect for mob
