...
//	extern WORD		dwAgiMax;
	...
	extern std::string	strCLICK_EFFECT;		//added by : SeiferXIII009 | 05-03-2012 | added mouse effect for char
	extern std::string	strTARGET_EFFECT;		//added by : SeiferXIII009 | 05-03-2012 | added mouse effect for mob
	extern std::string	strMINE_EFFECT;			//added by : SeiferXIII009 | 05-03-2012 | added item drop effect

	extern std::string	strTARGET_EFFECT_ENEMY;		//added by : geger009 | 05-03-2012 | added new mouse effect for mob
	extern std::string	strTARGET_EFFECT_NPC;		//added by : geger009 | 05-03-2012 | added new mouse effect for mob
	extern std::string	strTARGET_EFFECT_ALLIANCE;		//added by : geger009 | 05-03-2012 | added new mouse effect for mob
	extern std::string	strARROW_EFFECT_ENEMY;		//added by : geger009 | 05-03-2012 | added new mouse effect for mob
	extern std::string	strARROW_EFFECT_NPC;		//added by : geger009 | 05-03-2012 | added new mouse effect for mob
	extern std::string	strARROW_EFFECT_ALLIANCE;		//added by : geger009 | 05-03-2012 | added new mouse effect for mob
