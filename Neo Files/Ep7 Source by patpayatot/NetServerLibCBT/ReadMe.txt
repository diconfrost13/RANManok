========================================================================
    정적 라이브러리 : NetServerLibCBT 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 NetServerLibCBT 라이브러리 프로젝트를 만들었습니다. 
이 파일에는 NetServerLibCBT 응용 프로그램을 구성하는 각각의 파일에
들어 있는 요약 설명이 포함되어 있습니다.


NetServerLibCBT.vcproj
